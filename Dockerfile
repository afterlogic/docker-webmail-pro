...
LABEL Maintainer="Afterlogic Support <support@afterlogic.com>" \
      Description="Afterlogic WebMail Pro image for Docker - using Nginx, PHP-FPM 8, MySQL on Alpine Linux"
...
RUN wget -P /tmp https://afterlogic.com/download/webmail-pro-php.zip
RUN unzip -qq /tmp/webmail-pro-php.zip -d /var/www/html
